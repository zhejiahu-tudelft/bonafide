...
- **Audience:** Bona Fide members who know DCF and multiples. Define ARIMA and reverse DCF in one sentence when they first appear.
- **Delivery:**
  - The scripts are written at about 150 words a minute. Speak them, don't read them.
  - The *Numbers to say* are the only facts you must get exactly right.
- **Same text in PowerPoint:** each slide's section below is also in that slide's notes pane, for presenter view.
...
- Cut slide 11 to 1:00: read only signals 1, 3 and 6, then the offsets.

Slides 22 and 23 (industry and macro levers) are backup only; their key sentences are already in slides 6 and 9.

---

## Slide 1 · Title
**Time:** 0:20 (cumulative 0:20)

**Script:** Good evening. This is our pitch on Hewlett Packard Enterprise, HPE, priced at the close on 11 September 2026: $62.09. Over the next 24 minutes I won't just show you data. I'll show you how we reasoned from the data to a decision, and which patterns you can reuse on the next company.
...
Our fundamental range is $35 to $43, and even our bull case is $54. So we are not giving you a rating or a target. We are telling you the price is a bet that peak-cycle economics and sector multiples persist, and we will show you the signposts that would prove us wrong.

**Numbers to say:**
- 26% of revenue, 40% of profit;
- ROIC 11.2% vs WACC 9.3%;
- gross margin 40.4%;
- Q3 EPS +19% vs the top of guidance;
- free cash flow $4.5bn;
- 13.5x vs 4–10x;
- 18% margin / 11% growth;
- range $35–43, bull $54.
...
**Script:** We reasoned through five questions, each with a tool that could have proved us wrong:
...
**Script:** HPE sells servers, storage, networking and financing to enterprises, governments and cloud providers. Fully diluted market value is $89.7 billion, enterprise value $103.8 billion, and trailing revenue $41.9 billion, up 31%.

The table holds the first pattern: follow profit, not revenue.
...
**Script:** This comes from our practitioner Q&A work. The AI data centre has three business models:
- **landlords** like Digital Realty build and lease the building;
...
**Script:** The chart shows HPE's business lines over the last twelve months. Servers are half of revenue, and routing and data-centre networking grow fastest, much of it Juniper being consolidated.

The moat table:
- **Servers and AI systems:** bought competitively, so no moat.
- **Networking and storage:** narrow moats. Campus networks run through Aruba Central and Juniper Mist and are embedded in security policy, and routing uses HPE's own Express 5 silicon.
- **Financial Services:** a credit business.

A booming market doesn't create a moat either: in the second quarter HPE's server revenue grew 46% while the market grew 52% and Dell 165%.

The test that matters most is returns. HPE's adjusted after-tax ROIC averaged 8.1% from FY2020 to FY2025, below any reasonable cost of capital, and reached 11.2% only in this AI-cycle year. Juniper is a deliberate move toward the part of the stack with pricing power. But after $1.6 billion of impairments on earlier deals in FY2025, we want evidence in returns before we pay for the synergies.
...
**Script:** Start with the long view, and read the two boxes under the charts.
- **Revenue (left):** compounded at just 2.8% a year from FY2020 to FY2024, from $27 billion to $30 billion. FY2025 grew 13.8% with part of a Juniper year, and the last twelve months grew 30.8% to $41.9 billion. What changed is a full year of Juniper, AI systems and higher server prices.
- **Margins (right):** non-GAAP operating margin sat between 8.5 and 10.8% for six years; it is now 13.8% over twelve months and 16.2% in the latest quarter. GAAP gross margin rose to 36.7% from 30.3%, helped by networking mix and pricing. But GAAP operating margin is only 6.2%: the 7.6-point gap is mainly Juniper amortisation and stock-based compensation, which we treat as a real cost.

When a company that was flat for four years suddenly steps up, the job isn't to extrapolate; it is to ask what caused the step. Start with the latest quarter.
...
**Script:** Q3 FY26, reported on 2 September, was a record on every line.
- **Revenue:** $12.2 billion, up 34%, just above the top of guidance and 1% above consensus.
- **Margins:** non-GAAP gross margin a record 40.4%, up 10.5 points; operating margin 16.2%, up 7.7 points.
- **EPS:** $1.11, 19% above the top of guidance and 18% above consensus.
- **Cash and demand:** free cash flow $958 million; orders up 42% normalised; AI backlog a record $7.6 billion.
- **Segments:**
  - Networking grew 75% at a 22% margin, but only 10% on a normalised basis, because last year's quarter had just one month of Juniper.
  - Cloud & AI grew 25%, and its margin jumped from 7% to 17%.
- **Outlook, raised across the board:**
  - Q4 revenue guidance of $13.9 to $14.8 billion implies 44 to 53% growth;
  - FY26 EPS guidance went to $3.75–3.85;
  - the FY27 framework went to 13–17% revenue growth and at least $5 billion of free cash flow.

The chart shows how far FY26 EPS guidance has moved since last October, already past the FY2028 target. This is what a strong cycle looks like; the question is which parts repeat.

**Numbers to say:**
- revenue $12.2bn +34% (guide $11.5–12.1bn, consensus $12.1bn);
- gross margin 40.4% (+10.5pp); operating margin 16.2% (+7.7pp);
- EPS $1.11 (guide $0.88–0.93, consensus $0.94);
- free cash flow $958m; orders +42%; AI backlog $7.6bn;
...
- **The balance sheet (bottom row)** can absorb that:
  ...
  - dilution from the preferred and employee awards is 8.8%.

So the balance sheet isn't the risk; the quality of this year's cash is.
...
Our response: those multiples aren't independent evidence. Dell at 23 times already embeds the same AI-cycle assumptions we are testing. Relative value can tell you HPE is cheap against its sector; it can't tell you the sector is priced right.
...
**Script:** Instead of forecasting the price, we treat the price as the forecast and solve for what it requires.
- **Our DCF:** FY27 to FY36 at a 9.3% WACC (risk-free rate 4.95%, equity risk premium 3.97%, beta 1.35), with stock compensation expensed. It uses FY26 guidance and the FY27 framework, revenue up 15% at a 14.5% non-GAAP margin, fading to 12.5% long term.
- **Reversed, one variable at a time,** $62.09 needs one of:
  - a long-term non-GAAP margin of 18.4%, when HPE's range from FY2020 to FY2025 was 8.5 to 10.8% and the FY27 guide is 14–15%;
  - revenue growth of 10.8% a year for ten years instead of 5%;
  - a 7% cost of capital, which isn't plausible for a hardware company with a 1.4 beta.
- **Even if FY27's 14.5% margin held forever,** growth would still need to be 3.5 points faster than our base.

The logic: we don't have to be right about next quarter. We only have to ask whether the world the price implies is more likely than not, and here it looks like a stretch.
...
**Script:** The football field puts every method on one scale against the $62.09 price line.
- **Methods that value HPE's own cash flows cluster together:**
  - base DCF $38.80, with a $35 to $43 range for half a point either way on WACC and a quarter point on terminal growth;
  - probability-weighted scenario value $38.43;
  - an independent Damodaran model at $31.57, using a regional equity risk premium.
...
**Script:** Scenarios make the asymmetry explicit.
- **Bear (25%):** AI digestion and memory normalisation reverse this year's price gains, FY28 revenue falls 3%, and margin returns to 10.5%. Value: $22.
- **Base (50%):** the FY27 framework is delivered, growth fades to mid-single digits, and margin settles at 12.5%. Value: $38.80.
- **Bull (25%):** Oracle and Helios lift networking, and margin holds at 14.5%. Value: $54.
- **Probability-weighted:** $38.43.

The key point: even the bull case sits below today's price, so upside from here needs assumptions beyond what the evidence supports. The tornado on the right shows what matters: the discount rate, growth and long-term margin each swing value by about $12 to $14, while terminal growth and working capital matter much less. Margin is the one where the evidence is genuinely open, which is why margin durability is at the centre of our monitoring.
...
**Script:** The risk slide has one idea: the biggest risks are the forces that created the rally, running in reverse. For each one we trace the chain from revenue to margin to cash to balance sheet to valuation, and name the indicator to watch.

**Company-specific:**
- **Cloud & AI margin reversal:** memory prices fall, prices and gross margin fall together, and inventory bought at peak cost gets written down. Watch TrendForce prices and HPE's gross margin.
- **Networking execution:** share loss to Cisco and Arista, or missed synergies, hits the highest-margin revenue. Watch normalised growth and the Investor Day.
- **Lumpy AI deals and customer credit:** slippage swings free cash flow by billions. Watch backlog conversion and inventory days.

**External:**
- **AI capex digestion:** the largest valuation risk, because it hits both earnings and sector multiples.
- **Supply and trade policy.**
- **Rates:** each percentage point of WACC is worth roughly $6 to $8 a share.

Notice the asymmetry: most of these risks push value down from $38, and almost none push it toward $62.
...
**Script:** Here is the decision framework.
- **Left: our ranges against the price.** Intrinsic value is $35 to $43. Relative value is $67 to $106, but only if peer multiples hold.
- **Right: for $62.09 to be fair value, one of these must be true:**
  - an 18% long-term margin, when FY27 guidance is 14–15%;
  - 11% revenue growth for ten years, when our base is 5%;
  - a 7% cost of capital, or AI-hardware multiples that persist.

We don't need to predict which way the cycle turns. We need to know what would change our mind.
- **Upward:** Cloud & AI margin holding at 13% or more through a memory-price decline, networking growing mid-teens organically at 25%-plus margins, and FY27 free cash flow well above $5 billion with inventory normalising. Together those would lift the long-term margin toward 15% and our range toward $55–60: still below today's price, but close.
- **Downward:** non-GAAP gross margin back below 33%, a sequential decline in AI backlog, or a sector de-rating.

That is the conclusion: a better business, priced as if the cycle never turns, with a clear list of signposts to update on.
...
**Transition:** Open for questions; use the Q&A preparation below.
...
**1. Why no rating or price target?**
- A range reflects what the evidence supports: $35–43, probability-weighted $38, with fat-tailed returns.
- Our job is to show what the price implies and which signposts would change the value; the investment decision stays with the committee.

**2. Isn't a DCF structurally too harsh on an AI winner?**
- We used management's FY27 framework (+15%, 14.5% margin), and the bull case keeps a 14.5% margin forever.
- The reverse DCF turns the question around: if you believe an 18% long-term margin, you should own it. HPE's non-GAAP operating margin never exceeded 10.8% between FY2020 and FY2025.

**3. Why a 9.3% WACC?**
- Inputs: risk-free rate 4.95%; Damodaran implied equity risk premium 3.97%; bottom-up beta 1.35 (regression 1.40); pre-tax cost of debt 6.06% (BBB).
- Damodaran's own conventions (regional equity risk premium) give 11.06% and $31.57. Each ±1pp of WACC moves the base value between $33 and $47.
...
- Even the bull case, with networking mix above 30% at mid-to-high-20s margins, gives $54.

**6. Peers trade at 18–23x. Isn't HPE simply cheap?**
- Cheap against a sector is not cheap in absolute terms. Dell's 23x embeds AI-cycle assumptions, and HPE's own history is 4–10x.
- The sum of the parts applies Cisco's 29x EBIT multiple to a networking business whose normalised growth is about 10%.

**7. What bull case would you believe?**
- The upward signposts on slide 19: Cloud & AI margin at or above 13% through a memory decline; networking growing mid-teens organically at 25%-plus margins; FY27 free cash flow well above $5bn with inventory normalising.
...
- We subtract stock-based compensation (1.8% of revenue) and restructuring cash costs. TTM GAAP operating margin is 6.2% against 13.8% non-GAAP.

**10. If it is overvalued, why not short it?**
- Overvaluation is not a timing signal: 3σ days occur 6.8x as often as normal, the stock rose 19.5% in one day, and catalysts are near.
- Our work sets a range, not a trade. A short would need a catalyst and risk sizing, and our signposts are that catalyst list.

**11. How does HPE compare with Dell?**
- Dell: 20% gross margin, 9% operating margin, 23.0x P/E, AI backlog $95bn (Q2 FY27), revenue elasticity 0.84, share price +358% in a year.
- HPE: 37% gross margin, 6% GAAP operating margin, 13.5x, AI backlog $7.6bn, elasticity 0.41, +155%.
- HPE is less levered to AI and more networking-driven.

**12. What did the landlord / neocloud / server comparison change?**
- It placed HPE in the most shipment-driven, least contracted layer, which supports valuing it on through-cycle margins.
- For HPE, neoclouds' negative free cash flow shows up as customer-credit risk via Financial Services ($13.2bn portfolio at 7x leverage).

**13. Does Juniper's security history hurt HPE?**
- Not structurally: 8 known-exploited vulnerabilities, 8th of 13 vendors (Cisco 97).
- The risk is a new implant-style incident while HPE cross-sells; replacing end-of-life routers is revenue.

**14. How good was Q3, really?**
- **Strong on every line:**
  - revenue $12.2bn (+34%, 1% above consensus);
  - EPS $1.11 (18% above consensus, 19% above the top of guidance);
  - record 40.4% gross margin;
  - orders +42% normalised;
  - AI backlog $7.6bn.
- **Lower quality than the headline:**
  - about 78% of the operating-profit increase came from margin (estimate);
  - server growth was price-led;
  - Networking grew 10% normalised;
  - free cash flow was 48% of operating profit.
- **Verdict:** a great quarter for a cycle, not proof of a new earnings base.

**15. Is guidance conservative, or chasing the cycle?**
- **Both show up in the data:**
  - EPS beat the top of guidance in 5 of the last 6 quarters (conservative guiding);
  - FY26 guidance was raised repeatedly: revenue 17–22% → 34–37%, EPS $2.20–2.40 → $3.75–3.85.
- **Raises follow realised pricing and backlog** rather than anticipating them.
- **The FY27 framework already embeds some normalisation:** a 14–15% operating margin against 16.2% in Q3. Our base case uses that framework.

---

## Pattern toolkit: using the five patterns on another company
...
5. **The price is a forecast; think in ranges.**
   - Run the DCF backwards for margin, growth and WACC one at a time.
   - Compare with the company's history and guidance; track how guidance has moved; check return tails before sizing.

## Where the numbers come from
- **Deck and HTML report:** `final/HPE_Investment_Research.html`, sections 1–12.
- **Latest earnings:**
  - `data/processed_data/earnings/earnings_summary.json` (every keyed figure checked against the earnings PDFs in `report/earnings_materials/`);
  - Zacks consensus (S252).
- **Headline metrics:** `data/processed_data/key_metrics.json`.
- **Valuation:** `data/processed_data/valuation/valuation_summary.json`.
- **Statistics:** `data/processed_data/statistics/statistics_summary.json`.
- **Q&A 2:** `data/processed_data/qa/q2_summary.json`.
- **Q&A 1:** `data/processed_data/qa/kev_summary.json`.
- **Sources:** `report/source_log.csv`.
